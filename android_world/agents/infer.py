...
class Gpt4Wrapper(LlmWrapper, MultimodalLlmWrapper):
  ...
  def __init__(
    ...
    # Support direct API key or from environment variable
    if api_key:
      self.openai_api_key = api_key
    elif 'OPENAI_API_KEY' in os.environ:
      self.openai_api_key = os.environ['OPENAI_API_KEY']
    else:
      raise RuntimeError('OpenAI API key not set. Provide api_key parameter or set OPENAI_API_KEY environment variable.')
    
    # Support custom base URL or use default

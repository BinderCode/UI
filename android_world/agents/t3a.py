...
Action: {{"action_type": "status", "goal_status": "infeasible"}}"""
    ...
    print(f'[DEBUG] LLM Response: {action_output[:500]}')  # Print first 500 chars
    ...
    if (not reason) or (not action):
      ...
      print(f'[DEBUG] Full LLM Response: {action_output}')
      print(f'[DEBUG] Parsed reason: {reason}, action: {action}')
      step_data['summary'] = (

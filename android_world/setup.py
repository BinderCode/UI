...
# setup.py lives inside the android_world package dir; _ROOT_DIR is that package root.
_ROOT_DIR = os.path.dirname(os.path.abspath(__file__))
_PACKAGE_PROTOS = (
    'task_evals/information_retrieval/proto/state.proto',
    'task_evals/information_retrieval/proto/task.proto',
)
